...
public class PEPAudioManager {
     ...
     *
     * @param pepAudioListener the pep audio listener
     */
    ...
    public void pause() {
        if (videoPlayer != null) {
            ...
            pepAudioListener.onPlayState(false);
        }
    }
    ...
    public void play() {
        if (videoPlayer != null) {
            ...
            pepAudioListener.onPlayState(true);
        }
    ...
    private Handler handler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(@NonNull Message message) {
            ...
            pepAudioListener.onProgress(progress, bprogress, 1000, currentTime, durationTime);
            return false;
        }
    });
    ...
    private Player.EventListener eventListener = new Player.EventListener() {
        ...
        public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
            switch (playbackState) {
                ...
                case Player.STATE_BUFFERING:
                    pepAudioListener.onBuffering();
                    break;

                //播放完毕
                case Player.STATE_ENDED:
                    pepAudioListener.onPlayEnd();
                    break;

                //准备结束
                case Player.STATE_READY:
                    pepAudioListener.onPlayReady();
                    break;
                default:
                    break;
            }
        ...
        public void onPlayerError(ExoPlaybackException error) {
            pepAudioListener.onPlayerError(error);
        }
    };
